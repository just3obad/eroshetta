...
//        javax.swing.JScrollPane sp = new javax.swing.JScrollPane(jt);
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Contraindications:");
        ...
        drugProfileLayout.setHorizontalGroup(
            ...
            .addGroup(drugProfileLayout.createSequentialGroup()
                ...
                .addContainerGap())
            .addGroup(drugProfileLayout.createSequentialGroup()
                .addGroup(drugProfileLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanelPrescription.setMaximumSize(new java.awt.Dimension(442, 114));
        jPanelPrescription.setMinimumSize(new java.awt.Dimension(442, 114));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Panel_Drugs, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
...
//        System.out.println("matched is " + match);
        ...
        Collection<Diagnoses> diagnoses = selectedDrug.getDiagnosesCollection();
        Diagnoses diag;
        String contras = "";
        for(int k=0; k<diagnoses.size();k++)
        {
            diag = (Diagnoses) diagnoses.toArray()[k];
            contras = contras + diag.getName()+ ", ";
        }
        
        jLabel17.setText(contras);
        jLabel17.setToolTipText(contras);
...
//                System.out.println("Error Intializing the current patient.");
            ...
            try {
             ...
             try {
                ...
                jTextFieldAge.setText(String.valueOf(currentYear-birhtyear));
...
//            System.out.println("COME HERE AGAIN");
    ...
    public void disableProfilePatient(){
        jTextFieldPatientProfileName.setEditable(false);
        jTextFieldPatientProfileHeight.setEditable(false);
        jTextFieldPatientProfileWeight.setEditable(false);
        jTextFieldPPMedication.setEditable(false);
        jTextFieldPatientProfileName.setEditable(false);
...
//        jScrollPanePPDiagnosisMedication.setEnabled(false);
    ...
    public void enableProfilePatient(){
        jTextFieldPatientProfileName.setEditable(true);
        jTextFieldPatientProfileHeight.setEditable(true);
        jTextFieldPatientProfileWeight.setEditable(true);
        jTextFieldPPMedication.setEditable(true);
        jTextFieldPatientProfileName.setEditable(true);
